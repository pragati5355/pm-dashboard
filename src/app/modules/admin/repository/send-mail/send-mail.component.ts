        ...
        this.sendYmlFileForm = this._formBuilder.group(
            {
                ...
                subject: [
                    this.projectName +
                        '-' +
                        this.repositoryName +
                        ' | Need details for YML file ',
                    [Validators.required],
                ],
                message: [
                    'I am sharing with you the YML file for the project' +
                        this.projectName +
                        ' and repo ' +
                        this.repositoryName +
                        '. Can you please fill in the required details and share the file with me on the same email chain?',
                    [
                        Validators.required,
            ...
            {
                validator: [noWhitespaceValidator('message')],
            }
        );
    }
